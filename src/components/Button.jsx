...
const Button = ({ children, variant = 'primary', className = '', onClick, ...props }) => {
    ...
    const variants = {
        ...
        primary: "bg-colestia-gradient text-white shadow-[0_0_20px_rgba(122,30,166,0.5)] hover:shadow-[0_0_30px_rgba(201,43,141,0.6)] hover:scale-105 border border-transparent",
